                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      side:
                          BorderSide(color: AppTheme.danger.withOpacity(0.35)),
                    ),
                  ),
                ),
              ),
            ...
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppTheme.danger.withOpacity(0.12),
                  foregroundColor: AppTheme.danger,
                  side: BorderSide(color: AppTheme.danger.withOpacity(0.35)),
                ),
              ),
            ),
          ),
  ...
  Widget _buildMobileTopBar(NavigationController navController) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(
            bottom: BorderSide(color: AppTheme.primary.withOpacity(0.12))),
        boxShadow: [
          BoxShadow(
            ...
            onSelected: (value) {
              switch (value) {
                ...
                case 'settings':
                  ...
                  break;
                case 'logout':
                  authController.signOutAndClearAllData();
                  break;
              }
            },
...
Widget _getCurrentPageWidget(String pageKey) {
  switch (pageKey) {
    ...
    case 'course_details':
      {
        ...
        final selectedId = navController.selectedCourseId.value;
        if (selectedId == null) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            navController.navigateToPage('courses');
          });
        ...
        return CourseDetailsScreen(
          ...
          onClose: navController.closeCourseDetails,
        );
      }
    case 'vehicles':
    ...
    case 'fleet_details':
      {
        final navController = Get.find<NavigationController>();
        final selectedId = navController.selectedFleetId.value;
        if (selectedId == null) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            navController.navigateToPage('vehicles');
          });
        ...
        return FleetDetailsScreen(
          fleetId: selectedId,
          embeddedInShell: true,
          onClose: navController.closeFleetDetails,
        );
      }
    case 'schedules':
    ...
    case 'schedule_booking':
      {
        final navController = Get.find<NavigationController>();
        return SimplifiedScheduleBookingScreen(
          student: navController.selectedScheduleStudent.value,
          embeddedInShell: true,
          onClose: navController.closeScheduleBooking,
        );
      }
    case 'recurring_schedule':
      {
        final navController = Get.find<NavigationController>();
        return RecurringScheduleScreen(
          embeddedInShell: true,
          onClose: navController.closeRecurringSchedule,
        );
      }
    case 'billing':
    ...
    case 'student_invoice':
      {
        final navController = Get.find<NavigationController>();
        final selectedStudent = navController.selectedInvoiceStudent.value;
        ...
        return StudentInvoiceScreen(student: selectedStudent);
      }
    case 'receipts':
    ...
    case 'add_user':
      {
        ...
        return AddUserScreen(
          role: navController.selectedAddUserRole.value,
          embeddedInShell: true,
          onClose: navController.closeAddUser,
        );
      }
    case 'bulk_student_upload':
      {
        final navController = Get.find<NavigationController>();
        return BulkStudentUploadScreen(
          embeddedInShell: true,
          onClose: navController.closeBulkStudentUpload,
        );
      }
    case 'student_graduation':
      {
        final navController = Get.find<NavigationController>();
        final selectedStudent = navController.selectedGraduationStudent.value;
        if (selectedStudent == null) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            navController.navigateToPage('students');
          });
        ...
        return GraduationScreen(
          ...
          embeddedInShell: true,
          onClose: navController.closeStudentGraduation,
        );
      }
    case 'student_details':
      {
        final navController = Get.find<NavigationController>();
        final selectedId = navController.selectedStudentId.value;
        if (selectedId == null) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            navController.navigateToPage('students');
          });
        ...
        return StudentDetailsScreen(
          ...
          embeddedInShell: true,
          onClose: navController.closeStudentDetails,
        );
      }
    case 'instructor_details':
      {
        final navController = Get.find<NavigationController>();
        final selectedId = navController.selectedInstructorId.value;
        if (selectedId == null) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            navController.navigateToPage('instructors');
          });
        ...
        return InstructorDetailsScreen(
          instructorId: selectedId,
          embeddedInShell: true,
          onClose: navController.closeInstructorDetails,
        );
      }
    case 'quick_search':
    ...
    case 'profile':
      {
        ...
        return ProfileScreen(
          embeddedInShell: true,
          onClose: navController.closeProfile,
        );
      }
    case 'settings':
      return SettingsScreen();
    case 'sync':
      return const SyncStatusWidget(showAppBar: false);
    case 'subscription':
      return SubscriptionScreen(embeddedInShell: true);
    case 'reports':
      return FinancialReportsScreen();
    case 'course_reports':
