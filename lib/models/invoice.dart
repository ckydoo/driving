...
class Invoice {
  ...
  final int usedLessons; // Cached count of lessons consumed (from schedules)
  ...
  factory Invoice.fromMap(Map<String, dynamic> map) {
    return Invoice(
      ...
      usedLessons: map['used_lessons'] as int? ?? 0,
    );
  }
...
// Add these safe parsing methods to your Invoice class
  ...
  factory Invoice.fromJson(Map<String, dynamic> json) {
    try {
      debugPrint('📄 Parsing invoice from JSON: $json');
      ...
      debugPrint('❌ Error parsing Invoice from JSON: $e');
...
// ✅ ENHANCED: Safe parsing methods for Invoice that handle your data formats
  ...
  static DateTime? _parseDateTime(dynamic value) {
    ...
    try {
      ...
      debugPrint('⚠️ Error parsing DateTime from $value (${value.runtimeType}): $e');
    }
