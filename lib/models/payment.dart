...
class Payment {
  ...
  final bool isVoided; // Whether this payment has been voided
  final DateTime? voidedAt; // When the payment was voided
...
// Safe parsing methods for Payment class
  ...
  static DateTime? _parseDateTime(dynamic value) {
    ...
    try {
      ...
      debugPrint('⚠️ Error parsing DateTime from $value: $e');
    }
  ...
  Map<String, dynamic> toJson() => {
        ...
        'userId': userId,
        // Keep backward compatibility with DBs that don't yet have void columns.
        if (isVoided) 'is_voided': 1,
