...
class Schedule {
  ...
  factory Schedule.fromJson(Map<String, dynamic> json) {
    try {
      debugPrint('📅 Parsing schedule from JSON: $json');
      ...
      return Schedule(
        ...
        lessonsCompleted:
            _parseInt(json['lessonsCompleted'] ?? json['lessons_completed']) ??
                0,
      ...
      debugPrint('❌ Error parsing Schedule from JSON: $e');
...
// ✅ NEW: Safe parsing methods for Schedule
  ...
  static DateTime? _parseDateTime(dynamic value) {
    ...
    try {
      ...
      debugPrint(
          '⚠️ Error parsing DateTime from $value (${value.runtimeType}): $e');
    }
