...
// Add these methods to your _StudentInvoiceScreenState class
  ...
  void _printReceipt(Payment payment) async {
    try {
      ...
      if (course == null) {
        debugPrint('⚠️ Course not in controller, loading from database...');
...
// Enhanced method for recording payment with cloud receipt generation
  Future<void> recordPaymentWithReceipt(
    ...
    debugPrint('=== STARTING recordPaymentWithReceipt (Cloud) ===');
    ...
    try {
      ...
      try {
        ...
        debugPrint('✅ Cloud receipt generated: $downloadUrl');
        ...
        debugPrint('⚠️ Cloud receipt generation failed: $receiptError');
      ...
      debugPrint('=== recordPaymentWithReceipt (Cloud) COMPLETED ===');
    } catch (e) {
      debugPrint('=== ERROR in recordPaymentWithReceipt (Cloud) ===');
      debugPrint('Error: $e');
    ...
    try {
      ...
      final result = await ReceiptService.batchUploadReceipts(
        ...
        onProgress: (current, total) {
          ...
          debugPrint('Migration progress: $current/$total');
        },
      );
