...
class _PinLoginScreenState extends State<PinLoginScreen>
  ...
  Future<void> _initializeControllers() async {
    try {
      ...
      try {
        ...
        debugPrint('⚠️ Creating new PinController: $e');
      ...
      try {
        ...
        debugPrint('⚠️ Creating new AuthController: $e');
    ...
    try {
      ...
      if (success) {
        ...
        if (ApiService.hasToken) {
          debugPrint('✅ Sync available - proceeding to main app');
          AppRoutes.toMain();
        } else {
          debugPrint('⚠️ PIN login successful but sync unavailable');
  ...
  void _onPinChanged(int index, String value) {
    try {
      ...
      debugPrint('❌ Error in PIN change: $e');
    }
  }
