...
class _LoginScreenState extends State<LoginScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.bug_report, color: Colors.grey[700], size: 16),
              const SizedBox(width: 8),
              Text(
                'Debug Mode',
                style: TextStyle(
          ...
          Row(
            children: [
              ...
              Expanded(
                child: OutlinedButton(
                  onPressed: _fillDebugCredentials,
                  style: OutlinedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                  ),
                  child: const Text(
  ...
  Future<void> _debugDatabase() async {
    // This method should be available in your auth controller
    ...
    Get.dialog(
      AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Database debug info:'),
            const SizedBox(height: 8),
            Obx(() => Text(
                  'Firebase Available: ${_authController.firebaseAvailable.value}',
                  style: const TextStyle(fontSize: 12, fontFamily: 'monospace'),
                )),
            Obx(() => Text(
                  'User Logged In: ${_authController.isLoggedIn.value}',
                  style: const TextStyle(fontSize: 12, fontFamily: 'monospace'),
                )),
            Obx(() => Text(
                  'Firebase User: ${_authController.firebaseUser.value?.email ?? "None"}',
                  style: const TextStyle(fontSize: 12, fontFamily: 'monospace'),
                )),
            const SizedBox(height: 8),
            const Text(
  ...
  void _fillDebugCredentials() {
    _emailController.text = 'admin@drivingschool.com';
