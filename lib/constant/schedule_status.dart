class InvoiceStatus {
  ...
  static const List<String> allStatuses = [unpaid, partial, paid];

  static bool isValidStatus(String status) => allStatuses.contains(status);

  static String fromBalance(double balance, double total) {
