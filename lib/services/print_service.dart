...
class PrintService {
  ...
  static Future<bool> validatePrinterReady(String printerName) async {
    try {
      ...
      debugPrint('✅ Printer validation passed: $printerName');
      return true;
    } catch (e) {
      debugPrint('❌ Printer validation failed: $e');
      Get.snackbar(
        'Printer Error',
  ...
  static Future<List<PrinterInfo>> discoverPrintersByType(String type) async {
    try {
      debugPrint('🔍 Discovering $type printers...');
      ...
      debugPrint('✅ Found ${printers.length} $type printers');
      return printers;
    } catch (e) {
      debugPrint('❌ Error discovering $type printers: $e');
      return [];
    }
  }
  ...
  static Future<List<PrinterInfo>> discoverAllPrinters() async {
    ...
    try {
      ...
      debugPrint('❌ Error discovering all printers: $e');
    }
  ...
  static Future<bool> verifyPrinter(String printerName) async {
    try {
      ...
      debugPrint('❌ Error verifying printer: $e');
      return false;
    }
  }
  ...
  static Future<void> _printSingleReceipt({
    ...
    try {
      ...
      debugPrint('❌ Native printing failed: $e');
      Get.snackbar(
        'Print Error',
  ...
  static String _buildReceiptContent({
    ...
    receipt.writeln(_center('+263716826666', paperWidth));
    receipt.writeln();
    receipt.writeln();
    receipt.writeln();
  ...
  static String _buildInvoiceContent({
    ...
    invoice.writeln(_center('+263716826666', paperWidth));
    invoice.writeln();
    invoice.writeln();
    invoice.writeln();
  ...
  static Future<void> printBookingConfirmation({
    ...
    try {
      ...
      debugPrint('✅ Booking confirmation printed successfully');
      ...
      debugPrint('❌ Error printing booking confirmation: $e');
      Get.snackbar(
        'Print Error',
  ...
  static Future<void> printRecurringScheduleConfirmation({
    ...
    try {
      ...
      debugPrint('✅ Recurring schedule confirmation printed successfully');
      ...
      debugPrint('❌ Error printing recurring schedule confirmation: $e');
      Get.snackbar(
        'Print Error',
...
class PrinterInfo {
  ...
  static Future<bool> requestBluetoothPermissions() async {
    try {
      debugPrint('📱 Requesting Bluetooth permissions from Flutter...');
      final bool result =
  ...
  static Future<List<Map<String, dynamic>>> discoverPrinters({
    ...
    try {
      debugPrint('🔍 Starting printer discovery for type: $type');
      ...
      if (!hasPermissions && type.toLowerCase() == 'bluetooth') {
        debugPrint('⚠️ No Bluetooth permissions, requesting...');
      ...
      debugPrint('❌ Error discovering printers: ${e.message}');
  ...
  static Future<bool> verifyPrinter(String printerName) async {
    try {
      debugPrint('🔍 Verifying printer: $printerName');

      final result = await platform.invokeMethod('verifyPrinter', {
        'printerName': printerName,
      });

      debugPrint('✅ Printer verification result: $result');
      return result as bool;
    } on PlatformException catch (e) {
      debugPrint('❌ Error verifying printer: ${e.message}');
      return false;
    }
  }
  ...
  static Future<bool> printReceipt({
    ...
    try {
      ...
      debugPrint('   Paper size: $paperSize');
      ...
      debugPrint('❌ Error printing receipt: ${e.message}');
