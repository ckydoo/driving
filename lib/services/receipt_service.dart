...
class ReceiptService {
  ...
  static Future<String> generateAndUploadReceipt(
    ...
    try {
      debugPrint('📄 Generating local receipt for payment ${payment.id}');
  ...
  static Future<Map<String, dynamic>> batchUploadReceipts(
    ...
    for (int i = 0; i < payments.length; i++) {
      try {
        ...
        failureCount++;
        debugPrint('Failed to upload receipt for payment ${payments[i].id}: $e');
      }
    }
  ...
  static Future<String> _saveReceiptToLocal(
    ...
    try {
      ...
      debugPrint('❌ Error saving receipt to local storage: $e');
      rethrow;
    }
  }
  ...
  static Future<List<String>> getLocalReceipts() async {
    try {
      ...
      debugPrint('❌ Error getting local receipts: $e');
      return [];
    }
  }
  ...
  static Future<int> cleanupOldReceipts({int daysOld = 365}) async {
    try {
      ...
      debugPrint('❌ Error cleaning up receipts: $e');
      return 0;
    }
  }
  ...
  static Future<Invoice> _getInvoiceForPayment(Payment payment) async {
    try {
      ...
      debugPrint('❌ Error getting invoice for payment: $e');
      rethrow;
    }
  }
  ...
  static Future<User> _getStudentForInvoice(Invoice invoice) async {
    try {
      ...
      debugPrint('❌ Error getting student for invoice: $e');
      rethrow;
    }
  }
}
