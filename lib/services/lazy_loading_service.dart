...
class LazyLoadingService {
  ...
  static Future<Map<String, dynamic>> loadInitialSchedules({
    ...
    try {
      ...
      debugPrint('❌ Error loading initial schedules: $e');
      return {
        'schedules': <Schedule>[],
        'hasMore': false,
        'offset': 0,
  ...
  static Future<Map<String, dynamic>> loadMoreSchedules({
    ...
    try {
      ...
      debugPrint('❌ Error loading more schedules: $e');
      return {
        'schedules': <Schedule>[],
        'hasMore': false,
        'offset': offset,
  ...
  static Future<List<Schedule>> loadSchedulesForDateRange({
    ...
    try {
      ...
      debugPrint('❌ Error loading schedules for date range: $e');
      return [];
    }
  }
  ...
  static Future<List<Schedule>> loadSchedulesForStudent({
    ...
    try {
      ...
      debugPrint('❌ Error loading schedules for student: $e');
      return [];
    }
  }
  ...
  static Future<List<Schedule>> loadSchedulesByStatus({
    ...
    try {
      final maps = await db.query(
        'schedules',
        where: schoolId != null ? 'school_id = ? AND status = ?' : 'status = ?',
      ...
      debugPrint('❌ Error loading schedules by status: $e');
      return [];
    }
  }
  ...
  static Future<List<Fleet>> searchFleet({
    ...
    try {
      String whereClause =
          '(make LIKE ? OR model LIKE ? OR registration LIKE ?)';
      List<dynamic> whereArgs = ['%$query%', '%$query%', '%$query%'];
