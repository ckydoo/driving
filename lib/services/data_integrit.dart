...
class DatabaseIntegrityService {
  ...
  static Future<IntegrityReport> performIntegrityCheck() async {
    debugPrint('🔍 Starting database integrity check...');
    ...
    try {
      ...
      debugPrint('✅ Database integrity check completed');
  ...
  static Future<void> _checkForeignKeyConstraints(
    ...
    try {
      debugPrint('🔗 Checking foreign key constraints...');
      ...
      debugPrint('✅ Foreign key constraints checked');
    } catch (e) {
      debugPrint('❌ Error checking foreign key constraints: $e');
  ...
  static Future<void> _checkOrphanedRecords(
      Database db, IntegrityReport report) async {
    try {
      debugPrint('🔍 Checking for orphaned records...');
      ...
      debugPrint('✅ Orphaned records checked');
    } catch (e) {
  ...
  static Future<void> _checkDataConsistency(
    ...
    try {
      ...
      debugPrint('✅ Data consistency checked');
    } catch (e) {
      debugPrint('❌ Error checking data consistency: $e');
  ...
  static Future<void> _checkDuplicateRecords(
      Database db, IntegrityReport report) async {
    try {
      debugPrint('🔍 Checking for duplicate records...');
      ...
      debugPrint('✅ Duplicate records checked');
    } catch (e) {
      debugPrint('❌ Error checking duplicate records: $e');
  ...
  static Future<int> fixOrphanedPayments() async {
    try {
      debugPrint('🔧 Fixing orphaned payments...');
      ...
      debugPrint('✅ Fixed $deleteCount orphaned payments');
      return deleteCount;
    } catch (e) {
      debugPrint('❌ Error fixing orphaned payments: $e');
      return 0;
    }
  }
  ...
  static Future<int> fixInconsistentInvoiceAmounts() async {
    try {
      debugPrint('🔧 Fixing inconsistent invoice amounts...');
      ...
      for (final row in inconsistentInvoices) {
        ...
        fixedCount++;
        debugPrint('✅ Fixed invoice $invoiceId: $actualPaid paid, status: $status');
      }

      debugPrint('✅ Fixed $fixedCount inconsistent invoice amounts');
      return fixedCount;
    } catch (e) {
      debugPrint('❌ Error fixing inconsistent invoice amounts: $e');
      return 0;
    }
  }
  ...
  static Future<int> removeDuplicateRecords() async {
    try {
      debugPrint('🔧 Removing duplicate records...');
      ...
      debugPrint('✅ Removed $duplicateUsers duplicate users');
      ...
      debugPrint('✅ Removed $duplicateFleet duplicate fleet records');

      debugPrint('✅ Total removed $removedCount duplicate records');
      return removedCount;
    } catch (e) {
      debugPrint('❌ Error removing duplicate records: $e');
      return 0;
    }
  }
  ...
  static Future<FixResult> performAutomaticFixes() async {
    debugPrint('🔧 Performing automatic database fixes...');
    ...
    try {
      ...
      debugPrint('✅ Automatic fixes completed: ${fixResult.summary}');
    } catch (e) {
      debugPrint('❌ Error during automatic fixes: $e');
