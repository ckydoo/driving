        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              ...
              border: Border(
                bottom: BorderSide(
                  color: _colorScheme.primary.withOpacity(0.12),
                  width: 1,
                ),
              ),
              boxShadow: [
              ...
              children: [
                ...
                TabBar(
                  ...
                  indicator: BoxDecoration(
                    color: _colorScheme.primary.withOpacity(0.10),
      ...
      children: [
        if (authController.hasAnyRole(['admin', 'instructor']))
          _buildQuickActionButton(
            ...
            label: 'Sync Data',
            onTap: () {
              navigationController.navigateToPage('sync');
            },
        ...
        if (authController.hasAnyRole(['admin', 'instructor']))
          _buildQuickActionButton(
            ...
            label: 'Subscription',
            onTap: () {
              navigationController.navigateToPage('subscription');
            },
          ...
          InkWell(
            onTap: () async {
              try {
                ...
                debugPrint('Error opening admin portal: $e');
                Get.snackbar(
                  'Error',
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          InkWell(
            onTap: () async {
              final Uri whatsappUri = Uri.parse('https://wa.me/263716826666');
