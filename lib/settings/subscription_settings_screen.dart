...
class SubscriptionScreen extends StatelessWidget {
  ...
  SubscriptionScreen({super.key, this.embeddedInShell = false}) {
    ...
    return Scaffold(
      ...
      appBar: embeddedInShell
          ...
          : AppBar(
              ...
              title: const Text(
                AppTheme.subscriptionPageTitle,
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 20,
  ...
  Future<Map<String, dynamic>?> _createSubscriptionInvoice(
    ...
    try {
      debugPrint('🔄 Creating subscription invoice...');
      debugPrint('Package: ${package.name}, Period: $billingPeriod');
